    ...
    - You can replace block references with text, embed, alias, original or with text + alias. The most important of these is [text and alias](((7Zv5Vm1fO)))
        - **[Example](<Example.md>):**
            - from [Beating the Averages](<Beating the Averages.md>)
                ...
                4. [Jump to block](<Jump to block.md>) and [open in sidebar](<open in sidebar.md>) will do the same thing that clicking and shift-clicking (respectively) used to - they move either the focus of your main work area to that block - or open it in it's original context
                    - You can also do these operations with Control-o and Control-shift-o (o standing for open) respectively. 
                5. If you select [Replace With](<Replace With.md>) you will see the below menu:
                ...
                10. If you choose to replace with [text and alias](<text and alias.md>) you will get this:
